...
function ShowAdminUsers(){
	...
	const j=({
		...
		async function Send(){
			const wq=await fetch("https://evening-citadel-36388.herokuapp.com/user/admin/users",j);
...
function TableDisplay(){
	...
	function CreateUser(){
		...
		async function SendAdmin(){
			const q=await fetch("https://evening-citadel-36388.herokuapp.com/user/admin/create",j)
			return await q.json()
		}
		SendAdmin().then(resp=>{
			setTimeout(()=>{
